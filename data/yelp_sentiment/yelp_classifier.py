...
_TRAIN_DOWNLOAD_URL = "train_yelp_sentiment_classifier.txt"
_TEST_DOWNLOAD_URL = "test_yelp_sentiment_classifier.txt"
_VALID_DOWNLOAD_URL = "valid_yelp_sentiment_classifier.txt"


class YelpS(datasets.GeneratorBasedBuilder):
    def _info(self):
