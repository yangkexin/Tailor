...
_TRAIN_DOWNLOAD_URL = "train_yelp_food_prompt.txt"
_TEST_DOWNLOAD_URL = "test_yelp_food_prompt.txt"
_VALID_DOWNLOAD_URL = "valid_yelp_food_prompt.txt"


class YelpFP(datasets.GeneratorBasedBuilder):
    def _info(self):
