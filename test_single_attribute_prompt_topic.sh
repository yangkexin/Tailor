...
OUTPUT=gpt2_outputs/generate/yelp_food0_${TOKENIZER}_${SIZE}_prefix${PREFIX}_ck${IDS}.txt 
MODEl=gpt2_outputs/yelp_food0_${TOKENIZER}_${SIZE}_prefix${PREFIX}/checkpoint-${IDS}
